...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Image Section */}
      <div className="hidden lg:block w-1/2 bg-gradient-to-br from-blue-500 to-indigo-700">
        <div className="h-full flex items-center justify-center p-12">
          <div className="text-white text-center">
            <h1 className="text-4xl font-bold mb-4">Take Control of Your Finances</h1>
            <p className="text-xl opacity-90">Visualize, track, and optimize your financial health</p>
          </div>
        </div>
      </div>
